(ns marketentry.registry
  ...
  call to any real government-contracts portal. It builds the RECORD
  an operator would keep, not the act of submitting a filing itself
...
(defn register-draft
  ...
  market-entry operator's own act of preparing a government-contract
  filing package. Pure function -- does not touch any real government
  portal."
...
(defn register-submit
  ...
  government-contract filing (always human-gated upstream)."
  [engagement-id jurisdiction sequence]
  (when-not (and engagement-id (not= engagement-id ""))
