(ns marketentry.phase
  "Phase 0->3 staged rollout for the IRQ market-entry compliance
  actor.
  ...
  real government-contract filing package and submitting a real
  filing are the two real-world acts this actor performs; both are
  always a human market-entry operator's call. `marketentry.governor`'s
